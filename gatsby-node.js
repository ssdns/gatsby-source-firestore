...
var sourceNodes = function (_a, _b) {
    var createNode = _a.actions.createNode, createContentDigest = _a.createContentDigest, createNodeId = _a.createNodeId;
    var types = _b.types, databaseURL = _b.databaseURL;
...
var onCreateNode = function (_a) {
    var getNode = _a.getNode, node = _a.node, createParentChildLink = _a.actions.createParentChildLink;
    return __awaiter(void 0, void 0, void 0, function () {
        var parent_1;
        return __generator(this, function (_b) {
            if (node.internal.owner === "gatsby-source-firestore") {
                if (node.parent) {
                    parent_1 = getNode(node.parent);
                    createParentChildLink({ parent: parent_1, child: node });
                }
            }
            return [2];
        });
